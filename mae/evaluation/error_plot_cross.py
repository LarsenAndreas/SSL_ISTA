...
if training_percentage == 80:
    ISTANet = ['ISTANet_80p-flowers_pets.npy', 'ISTANet_80p-pets_flowers.npy']
    ISTA2Net = ['ISTANet_80p_d2v-flowers_pets.npy', 'ISTANet_80p_d2v-pets_flowers.npy']
    MAE = ['maesr-flowers-good_pets.npy', 'maesr-pets-good_flowers.npy']
    MMAE = ['mmaesr-flowers-good_pets.npy', 'mmaesr-pets-good_flowers.npy']
elif training_percentage == 1:
    ISTANet = ['ISTANet_1p-flowers_pets.npy', 'ISTANet_1p-pets_flowers.npy']
    ISTA2Net = ['ISTANet_1p_d2v-flowers_pets.npy', 'ISTANet_1p_d2v-pets_flowers.npy']
    MAE = ['maesr_1p-flowers_pets.npy', 'maesr_1p-pets_flowers.npy']
    MMAE = ['mmaesr_1p-flowers_pets.npy', 'mmaesr_1p-pets_flowers.npy']
...
for means, stds in zip(PSNR_means.items(), PSNR_stds.items()):
    ...
    rects = ax.bar(x + offset, average, spacing, label=dataset, align='edge', color=color, yerr=std, capsize=5, hatch='/', edgecolor='w')
